...
class Employee extends Dbconfig {	
	...
	public function updateEmployee(){
		if($_POST['empId']) {	
			...
			SET name = '".$_POST["empName"]."', email = '".$_POST["email"]."', designation = '".$_POST["designation"]."', salary = '".$_POST["salary"]."' , date = '".$_POST["date"]."'
			WHERE id ='".$_POST["empId"]."'";
			$isUpdated = mysqli_query($this->dbConnect, $updateQuery);		
		}	
	}
	public function addEmployee(){
		$insertQuery = "INSERT INTO ".$this->empTable." (name, email, designation, salary, date) 
			VALUES ('".$_POST["empName"]."', '".$_POST["email"]."', '".$_POST["designation"]."','".$_POST["salary"]."' , '".$_POST["date"]."')";
